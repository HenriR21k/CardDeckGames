...
{	  		    	         	   		 	
  ...
  {	  		    	         	   		 	
    ...
    Card spadeKing = new Card ("Spade", "King");	  		    	         	   		 	
    ...
    for (int i = 0; i < 5; i++)	  		    	         	   		 	
    {	  		    	         	   		 	
      int randNum = (int)(Math.random() * (cardDeck.size() - 0 + 1) + 0);	  		    	         	   		 	
      player1Hand.add(cardDeck.get(randNum));	  		    	         	   		 	
      cardDeck.remove(randNum);	  		    	         	   		 	
    }	  		    	         	   		 	
	  		    	         	   		 	
    for (Card cards: player1Hand)	  		    	         	   		 	
    {	  		    	         	   		 	
      System.out.println(cards.getFace()+" of "+cards.getSuit()+"s");	  		    	         	   		 	
    }	  		    	         	   		 	
